...
object homeScreen : NavigationDestination{
    ...
    override val titleRes = Res.string.title_home
}

@Composable
fun HomeScreen(
    onNavigateToFisicas: () -> Unit,
    onNavigateToMorales: () -> Unit,
) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        MenuOptionCard(
            ...
            icon = Icons.Default.Place, // O Icons.Default.Build si prefieres herramientas
            containerColor = MaterialTheme.colorScheme.secondaryContainer,
            contentColor = MaterialTheme.colorScheme.onSecondaryContainer,
            onClick = onNavigateToMorales
        )
    }
}
